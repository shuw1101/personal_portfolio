...
export const Banner = () => {
  ...
  const toRotate = ["Software Developer","Passionate & Fast Learner"];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Shuwen,`} <span className="txt-rotate" dataPeriod="1000" data-rotate='["Software Developer","Passionate & Fast Learner"]'><span className="wrap">{text}</span></span></h1>
